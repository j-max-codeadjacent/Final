...
df.columns = ['book', 'author', 'sentence', 'sentence_length', 'avg_word_length'  "question", "ex_point", "colon", "semi_colon"]
...
predictors = ['sentence_length', 'avg_word_length' 'question', 'ex_point', 'colon', 'semi_colon']
X = df[predictors]
