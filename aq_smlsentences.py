...
ws1.cell(row=1, column=2).value = 'sentence_length'
ws1.cell(row=1, column=3).value = 'question'
ws1.cell(row=1, column=4).value = 'ex_point'
ws1.cell(row=1, column=5).value = 'colon'
ws1.cell(row=1, column=6).value = 'semi_colon'

entry = 2
for auth in auth_feat_imp:
	ws1.cell(row = entry, column = 1).value = auth
	ws1.cell(row = entry, column = 2).value = auth_feat_imp[auth][0]
	ws1.cell(row = entry, column = 3).value = auth_feat_imp[auth][1]
	ws1.cell(row = entry, column = 4).value = auth_feat_imp[auth][2]
	ws1.cell(row = entry, column = 5).value = auth_feat_imp[auth][3]
	ws1.cell(row = entry, column = 6).value = auth_feat_imp[auth][4]
	entry +=1

wb.save('aq_exceldata/aq_exceldata.xlsx')
