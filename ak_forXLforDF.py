...
wb = Workbook()
ws1 = wb.create_sheet('sentences')
ws1.cell(row=1, column=1).value = 'title'
ws1.cell(row=1, column=2).value = 'sentence'
ws1.cell(row=1, column=3).value = 'lowercase_sent'
ws1.cell(row=1, column=4).value = 'length'
ws1.cell(row=1, column=5).value = 'lexical_div'


row_num = 2

for x in sentencesbybook_forDF:
	ws1.cell(row=row_num, column=1).value = x[0]
	ws1.cell(row=row_num, column=2).value = x[1]
	ws1.cell(row=row_num, column=3).value = x[2]
	ws1.cell(row=row_num, column=4).value = x[3]
	ws1.cell(row=row_num, column=5).value = x[4]
	row_num += 1

wb.save('exceldata/sentenceData/sentences.xlsx')
